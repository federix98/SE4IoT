...
public class LightSensor implements Sensor, Actuator, Runnable {
	...
	public LightSensor(String name, String baseTopic) throws MqttException {
		client = new MqttClient("tcp://localhost:1883", "pahomqtt lightsensor" + name);
		client.connect();
		this.active = true;
